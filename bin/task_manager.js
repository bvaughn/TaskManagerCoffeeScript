...
EventDispatcher = (function() {
  ...
  */
  ...
  EventDispatcher.prototype.addEventListener = function(eventType, method) {
    var proxy, _i, _len, _ref;
    ...
    return this.proxies[eventType].push(method);
  };
  ...
  */
  ...
  EventDispatcher.prototype.removeEventListener = function(eventType, method) {
    var index, proxy, _i, _len, _ref, _results;
...
Event = (function() {
  ...
  */
  ...
  set({
    dispatcher: function(_dispatcher) {
